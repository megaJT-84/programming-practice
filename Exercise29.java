...
//		}
	...
	public void partImage() {
		Rect roi = new Rect(rect[0][0]+60, rect[0][1]+20, (rect[1][0] - rect[0][0])*2, (rect[1][1] - rect[0][1])*2);
...
//		bimage2 = matToBufferedImage(mosaic);
	...
	public static BufferedImage matToBufferedImage(Mat matrix) {
		...
		BufferedImage image1 = new BufferedImage(cols, rows, type);
		image1.getRaster().setDataElements(0, 0, cols, rows, data);
		return image1;
	}
